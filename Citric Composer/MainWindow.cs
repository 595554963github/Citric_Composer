...
namespace Citric_Composer {
    ...
    public class MainWindow : EditorBase {
        ...
        public MainWindow() : base(typeof(SoundArchive), "声音档案", "sar", "柠檬音乐工坊", null) {
            Text = "柠檬音乐工坊";
        ...
        public MainWindow(string fileToOpen) : base(typeof(SoundArchive), "声音档案", "sar", "柠檬音乐工坊", fileToOpen, null) {
            SoundArchive.FilePath = fileToOpen;
            Text = "柠檬音乐工坊-" + Path.GetFileName(fileToOpen);
            Icon = Properties.Resources.Citric_Composer;
            toolsTabMainWindow.Visible = true;
            EntryPlayer.Initialize();
        }
        ...
        public override void saveToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            if (FilePath.ToLower().EndsWith("csar")) {
                if (File.WriteMode == WriteMode.Cafe || File.WriteMode == WriteMode.C_BE) {
                    ...
                    MessageBox.Show("不存在大端序的BCSAR...再次检查字节顺序.");
                    return;
                } else {
            ...
            //A sound entry.
                ...
                if (tree.SelectedNode.Parent.Parent == null) {
                    ...
                    //Wave sound data.
                        ...
                        if (File.WaveSoundDatas[ind] != null) {
                            ...
                            //Status.
                            status.Text = "声音" + (ind + File.Streams.Count) + "已选择.";
                            ...
                            nullDataPanel.Show();
                            nullDataPanel.BringToFront();
                            status.Text = "{空的}声音" + (ind + File.Streams.Count) + "已选择.";
                        }
                    ...
                    //Sequences.
                        ...
                        if (File.Sequences[ind] != null) {
                            ...
                            seqBank0Box.Items.Add("{空音色库}");
                            seqBank1Box.Items.Add("{空音色库}");
                            seqBank2Box.Items.Add("{空音色库}");
                            seqBank3Box.Items.Add("{空音色库}");
                            int bnkCount = 0;
                            ...
                            //Status.
                            status.Text = "声音" + (ind + File.Streams.Count + File.WaveSoundDatas.Count) + "已选择.";
                            if (File.Sequences[ind].File != null) {
                                if (File.Sequences[ind].File.File != null) {
                            ...
                            nullDataPanel.Show();
                            nullDataPanel.BringToFront();
                            status.Text = "{空的}声音" + (ind + File.Streams.Count + File.WaveSoundDatas.Count) + "已选择.";
                        }
                    ...
                    //Sound groups.
                        ...
                        if (File.SoundSets[ind] != null) {
                            ...
                            for (int i = 0; i < File.Files.Count; i++) {
                                ...
                                string name = "{空文件或未知名称}";
                                try { name = File.Files[i].FileName + "." + File.Files[i].FileExtension; } catch { }
                                if (name == null) { name = "{空文件或未知名称}"; }
                                if (name.Equals("{空文件或未知名称}")) { name = "{空文件或未知名称}"; }
                            ...
                            if (wsd) {
                                ...
                                ((DataGridViewComboBoxColumn)soundGrpWaveArchives.Columns[0]).Items.Add("{空波形档案}");
                                for (int i = 0; i < File.WaveArchives.Count; i++) {

                                    //Name of wave archive.
                                    string name = "{空档案或未知名称}";
                                    try { name = File.WaveArchives[i].Name; } catch { }
                                    if (name == null) { name = "{空档案或未知名称}"; }
                                    if (name.Equals("{空档案或未知名称}")) { name = "{空档案或未知名称}"; }
                            ...
                            //Status.
                            status.Text = "声音组" + ind + "已选择.";

                        } else {
                            nullDataPanel.Show();
                            nullDataPanel.BringToFront();
                            status.Text = "{空的}声音组" + ind + "已选择.";
                        }
                    ...
                    //Banks.
                        ...
                        if (File.Banks[ind] != null) {
                            ...
                            ((DataGridViewComboBoxColumn)bankWarDataGrid.Columns[0]).Items.Add("{空波形档案}");
                            for (int i = 0; i < File.WaveArchives.Count; i++) {
                    ...
                    //Player.
                        ...
                        if (File.Players[ind] != null) {
                            ...
                            //Status.
                            status.Text = "播放器" + ind + "已选择.";

                        } else {
                            nullDataPanel.Show();
                            nullDataPanel.BringToFront();
                            status.Text = "{空的}播放器" + ind + "已选择.";
                        }
                        ...
                        if (File.Files[ind] != null) {
                            ...
                            if (File.Files[ind].Groups != null) {                            
                                ...
                                for (int i = 0; i < File.Groups.Count; i++) {
                                    ...
                                    if (name == null) { name = "{空组或未知名称}"; }
                                    if (name.Equals("{空组或未知名称}")) { name = "{空组或未知名称}"; }
                            ...
                            //Status.
                            status.Text = "文件" + ind + "已选择." + (File.Files[ind].File == null ? "" : (" (" + BytesToString(SoundArchiveWriter.WriteFile(File.Files[ind].File).Length) + ")"));

                        } else {
                            nullDataPanel.Show();
                            nullDataPanel.BringToFront();
                            status.Text = "{空的}文件" + ind + "已选择.";
                        }
                ...
                //Special cases.
                    ...
                    if (tree.Nodes["streams"] == tree.SelectedNode.Parent.Parent) {
                        ...
                        //Status.
                        status.Text = "轨道" + tree.SelectedNode.Index + "流的" + tree.SelectedNode.Parent.Index + "已选择.";
            ...
            if (tree.SelectedNode.Parent != null) {
                ...
                if (tree.SelectedNode.Parent == tree.Nodes["waveArchives"]) {
                    ...
                    if (File.WaveArchives[tree.SelectedNode.Index].File != null) {
                        ...
                        MessageBox.Show("你无法为没有附加文件的条目打开文件!", "通知:");
                ...
                //Parent is the streams.
                    ...
                    if (File.Streams[tree.SelectedNode.Index].File != null) {
                        ...
                        if (File.Streams[tree.SelectedNode.Index].File.FileType != EFileType.External) {
                            ...
                            //Wut.
                            MessageBox.Show("由于伊莎贝拉的特性，你必须通过文件夹中的文件打开内部流.", "通知:");
        ...
        public override void UpdateNodes() {
            ...
            if (tree.Nodes.Count < 11) {
                tree.Nodes.Add("versions", "版本编辑", 12, 12);
                tree.Nodes.Add("streams", "声音流", 1, 1);
                tree.Nodes.Add("waveSoundDatas", "波形声音条目", 2, 2);
                tree.Nodes.Add("sequences", "声音序列", 3, 3);
                tree.Nodes.Add("soundGroups", "声音组", 4, 4);
                tree.Nodes.Add("banks", "音色库", 5, 5);
                tree.Nodes.Add("waveArchives", "波形档案", 6, 6);
                tree.Nodes.Add("groups", "组", 7, 7);
                tree.Nodes.Add("players", "播放器", 8, 8);
            ...
            if (FileOpen && File != null) {
                ...
                foreach (var s in File.Streams) {
                    ...
                    //Null.
                    if (s == null) {
                        tree.Nodes["streams"].Nodes.Add("stream" + stmCount, "[" + stmCount + "] " + "{空的流}", 1, 1);
                    }
                ...
                foreach (var w in File.WaveSoundDatas) {
                    ...
                    //Null.
                    if (w == null) {
                        tree.Nodes["waveSoundDatas"].Nodes.Add("waveSoundData" + wsdCount, "[" + wsdCount + "] " + "{空的波形声音集}", 2, 2);
                    }
                ...
                foreach (var s in File.Sequences) {
                    ...
                    //Null.
                    if (s == null) {
                        tree.Nodes["sequences"].Nodes.Add("sequence" + seqCount, "[" + seqCount + "] " + "{空的序列}", 3, 3);
                    }
                ...
                foreach (var b in File.Banks) {
                    ...
                    //Null.
                    if (b == null) {
                        tree.Nodes["banks"].Nodes.Add("bank" + bCount, "[" + bCount + "] " + "{空音色库}", 5, 5);
                    }
                ...
                foreach (var g in File.Groups) {
                    ...
                    //Null.
                    if (g == null) {
                        tree.Nodes["groups"].Nodes.Add("group" + gCount, "[" + gCount + "] " + "{空的组}", 7, 7);
                    }
                ...
                foreach (var w in File.WaveArchives) {
                    ...
                    //Null.
                    if (w == null) {
                        tree.Nodes["waveArchives"].Nodes.Add("waveArchives" + wCount, "[" + wCount + "] " + "{空波形档案}", 6, 6);
                    }
                ...
                foreach (var s in File.SoundSets) {
                    ...
                    //Null.
                    if (s == null) {
                        tree.Nodes["soundGroups"].Nodes.Add("soundGroup" + sCount, "[" + sCount + "] " + "{空的声音组}", 4, 4);
                    }
                    ...
                    //Valid.
                        ...
                        for (int i = s.StartIndex; i <= s.EndIndex; i++) {
                            ...
                            if (key.Equals("null") || s.StartIndex == 0xFFFFFF) {
                                ...
                                //Add null.
                                tree.Nodes["soundGroups"].Nodes["soundGroup" + sCount].Nodes.Add("entry" + i, "{空的类型}", 0, 0);
                ...
                foreach (var f in File.Files) {
                    ...
                    //Null.
                    if (f == null) {
                        tree.Nodes["files"].Nodes.Add("file" + fCount, "[" + fCount + "] " + "{空的文件}", 0, 0);
                    }
        ...
        public override void WsdCopyCount_Click(object sender, EventArgs e) {
            if (!WritingInfo && FileOpen) {
                ...
                } catch { MessageBox.Show("无法从相应的波形文件中读取音轨信息."); }
            }
        }
        ...
        public override void ExportToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            s.Filter = "声音文件|*.bf" + be + ";*.bc" + be + "|Switch声音文件|*.bf" + be;
        ...
        public override void ChangeExternalPathToolStripMenuItem_Click(object sender, EventArgs e) {
            string h = Microsoft.VisualBasic.Interaction.InputBox("新的外部路径", "输入路径:", File.Files[tree.SelectedNode.Index].ExternalFileName);
            if (h != "") {
        ...
        public override void SarExport_Click(object sender, EventArgs e) {
            ...
            if (f == null) {
                MessageBox.Show("你不能导出没有附加文件的条目!");
                return;
            }
        ...
        public override void SarReplace_Click(object sender, EventArgs e) {
            ...
            if (f == null) {
                MessageBox.Show("你不能导入到没有关联文件的条目中!");
                return;
            }
        ...
        public override void SarRename_Click(object sender, EventArgs e) {
            string h = Microsoft.VisualBasic.Interaction.InputBox("新名称", "输入名称:", tree.SelectedNode.Text.Split(']')[1].Substring(1));
            if (h != "") {
                string node = tree.SelectedNode.Parent.Name;
                if (node.Equals("stream")) {
        ...
        public void CreateStream(int index) {
            ...
            if (File.Players.Count == 0) {
                MessageBox.Show("必须至少有一个播放器才能创建声音条目!");
                return;
            }
        ...
        public void RemoveBank(int index) {
            ...
            foreach (var e in File.Sequences) {
                if (e.Banks.Contains(File.Banks[index])) {
                    MessageBox.Show("你无法删除此音色库，因为它被序列使用" + e.Name + ".");
                    return;
                }
            }
        ...
        public void RemoveWaveArchive(int index) {
            ...
            foreach (var e in File.Banks) {
                if (e.WaveArchives.Contains(File.WaveArchives[index])) {
                    MessageBox.Show("你无法删除此波形档案，因为它正被使用" + e.Name + ".");
                    return;
                }
            }
                ...
                if (file.File != null) {
                    ...
                    if (f != null) {
                        foreach (var w in f.Waves) {
                            if (w.WarIndex == index) {
                                MessageBox.Show("你无法删除此波形档案,因为它正被音色库文件使用" + file.FileName + "." + file.FileExtension + ".");
                                return;
                            }
                        }
                    }
            ...
            foreach (var file in File.Files) {
                if (file.File != null) {
                    ...
                    if (f != null) {
                        foreach (var w in f.Waves) {
                            if (w.WarIndex == index) {
                                MessageBox.Show("你无法删除此波形档案,因为它正被波形数据文件使用" + file.FileName + "." + file.FileExtension + ".");
                                return;
                            }
                        }
                    }
        ...
        public void RemovePlayer(int index) {
            ...
            foreach (var e in File.Sequences) {
                if (e.Player == File.Players[index]) {
                    MessageBox.Show("你不能删除这个播放器,因为它正被序列使用" + e.Name + ".");
                }
            }
            foreach (var e in File.Streams) {
                if (e.Player == File.Players[index]) {
                    MessageBox.Show("你不能删除这个播放器r,因为它正被流使用" + e.Name + ".");
                }
            }
            foreach (var e in File.WaveSoundDatas) {
                if (e.Player == File.Players[index]) {
                    MessageBox.Show("你不能删除这个播放器,因为它正被波形声音数据条目使用" + e.Name + ".");
                }
            }
