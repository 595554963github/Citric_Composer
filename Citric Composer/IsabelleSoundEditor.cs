...
namespace Citric_Composer
{
    ...
    {   
        ...
        public IsabelleSoundEditor(Brewster_WAR_Brewer war2, int index, string text)
        {
            ...
            //Transform Isabelle.
            this.Text = "伊莎贝拉声音编辑器(WAR模式) - " + text;
            fileNamePath = "INTERNAL";
            openToolStripMenuItem.Text = "从文件导入";
            ...
            exportBinaryToolStripMenuItem.Text = "另存为";
        ...
        public IsabelleSoundEditor(MainWindow mainWindow, int index, string text, bool wave) {
            ...
            //Transform Isabelle.
            this.Text = "伊莎贝拉声音编辑器(SAR模式) - " + text;
            fileNamePath = "INTERNAL";
            openToolStripMenuItem.Text = "从文件导入";
            closeToolStripMenuItem.Visible = false;
            exportBinaryToolStripMenuItem.Image = saveAsToolStripMenuItem.Image;
        ...
        public IsabelleSoundEditor(string fileToOpen) {
            ...
            file = new FISP();
            fileOpen = true;
            if (launchMode == 0) { this.Text = "伊莎贝拉声音编辑器-新建项目.fisp"; }
            ...
            switch (fileToOpen.Substring(fileToOpen.Length - 4)) {
                ...
                case "cisp":
                    ...
                    if (fileToOpen.EndsWith(".cisp")) {
                        ...
                        Text = "伊莎贝拉声音编辑器-" + Path.GetFileName(fileToOpen);
                    }
                    break;
        ...
        private void add_Click(object sender, EventArgs e)
        {
            ...
            else if (tree.SelectedNode.Index == 1)
            {
                ...
                MessageBox.Show("要将音频添加到项目中，可以通过导入现有音频来创建一个新项目。");
                ...
                switch (tree.SelectedNode.Parent.Index)
                {
                    ...
                    case 2:
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("无法导出包含不存在声道的音轨!");
                            error = true;
                        }
                        if (file.stream.isLoop)
                        {
        ...
        public void saveAs() {
            ...
            if (saveFISP.FileName != "") {
                ...
                if (launchMode == 0)
                {
                    ...
                    saveFISP.FileName = "";
                    this.Text = "伊莎贝拉声音编辑器-" + Path.GetFileName(fileNamePath);
                    save();
        ...
        private void importFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (j == 0 || j == 1)
            {
                ...
                {
                    if (launchMode == 0) { this.Text = "伊莎贝拉声音编辑"; }
                }
        ...
        private void exportBinaryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (fileOpen)
            {
                ...
                if (file.data.data.Count() > 0)
                {
                    ...
                    MessageBox.Show("要导出二进制文件，您至少需要一个声道!");
                }

            }
            else {
                MessageBox.Show("你首先需要打开一个文件!");
            }
        ...
        private void streamToPrefetchToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            if (o.FileName != "") {
                ...
                d.Filter = "3ds或WiiU预取|*.bfstp;*.bcstp|Switch预取|*.bfstp";
                d.ShowDialog();
