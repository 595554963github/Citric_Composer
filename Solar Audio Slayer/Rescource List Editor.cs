...
namespace SolarAudioSlayer {
    public partial class RescourceListEditor : EditorBase {
        ...
        public RescourceListEditor(MainWindow mainWindow) : base(typeof(AudioRescourceList), "资源列表", "arslist", "资源列表编辑器", mainWindow) {
            InitializeComponent();
            Text = "资源列表编辑器";
            //ICON.
        }
        ...
        public override void UpdateNodes() {
            ...
            if (tree.Nodes.Count < 2) {
                tree.Nodes.Add("rescources", "资源", 7, 7);
            }
            ...
            if (FileOpen) {
                ...
                foreach (var r in (File as AudioRescourceList).FileNames) {
                    ...
                    tree.Nodes["rescources"].Nodes["rescource" + rCount].ContextMenuStrip.Items[4].Text = "重命名";
            ...
            if (FileOpen && File != null) {
                ...
                //Parent is not null.
                    ...
                    if (tree.SelectedNode.Parent == tree.Nodes["rescources"]) {
                        ...
                        //Show status.
                        status.Text = "资源: " + tree.SelectedNode.Index;
        ...
        public override void NodeBlank() {
            if (FileOpen) {
                string name = Interaction.InputBox("新名称:", "重命名资源", (File as AudioRescourceList).FileNames[tree.SelectedNode.Index], -1, -1);
                if (name != "") {
